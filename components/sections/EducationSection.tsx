...
const EDUCATION_QUERY =
  ...
  defineQuery(`*[_type == "education"] | order(defined(startDate) desc, endDate desc, startDate desc){
  institution,
  degree,
  fieldOfStudy,
  startDate,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {education.map((edu) => (
            ...
            >
              ...
              <div className="absolute top-0 left-0 right-0 h-1 bg-linear-to-br from-[#5f81d0] via-[#21387f] to-[#101329] z-10" />
