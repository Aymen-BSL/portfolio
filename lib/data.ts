export const projects = [
  ...
  },
  {
    ...
    img: "/RoofingWebsite.webp",
    iconLists: ["/next.svg", "/tail.svg", "/ts.svg", "/fm.svg"], // Assuming you used Next.js, Tailwind CSS, TypeScript, and Framer Motion
  ...
  /* {
    id: 3,
    title: "Nike Store",
    des: "An online store concept for Nike, featuring sleek product displays and an intuitive shopping experience to engage and convert customers.",
    img: "/nike.webp",
    iconLists: ["/re.svg", "/re.svg", "/tail.svg", "/ts.svg"],
    link: "https://nike-store-pi-roan.vercel.app",
  }, */
  /* {
    id: 4,
    title: "Gerícht fine dining",
    des: "A sophisticated fine dining website concept, presenting an elegant menu and ambiance to attract discerning diners.",
    img: "/restau.webp",
    iconLists: ["/next.svg", "/tail.svg", "/ts.svg", "c.svg"],
    link: "https://gericht-fine-dining-chi.vercel.app",
  }, */
];
