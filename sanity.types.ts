...
// Source: ./components/RecentProjects.tsx
// Variable: PROJECTS_QUERY
// Query: *[_type == "showcaseProject"] | order(_createdAt desc) {    _id,    title,    des,    img,    iconLists,    link  }
...
// Source: ./components/sections/ApproachSection.tsx
// Variable: APPROACH_QUERY
// Query: *[_type == "approach"] | order(phase asc) {    _id,    phase,    title,    description,    animationSpeed,    containerClassName,    colors  }
export type APPROACH_QUERYResult = Array<{
  _id: string;
  phase: string | null;
  title: string | null;
  description: string | null;
...
// Query: *[_type == "education"] | order(defined(startDate) desc, endDate desc, startDate desc){  institution,  degree,  fieldOfStudy,  startDate,  endDate,  current,  gpa,  description,  achievements,  logo,  website,  order}
...
// Query: *[_type == "skillCategory"] | order(_createdAt asc) {    category,    items,    icon  }
