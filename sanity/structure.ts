          ...
          S.list()
            ...
            .items([
              ...
              S.listItem()
                ...
                .icon(ProjectsIcon)
                .schemaType("showcaseProject")
                .child(S.documentTypeList("showcaseProject").title("Projects")),
              ...
              S.listItem()
                ...
                .icon(SearchIcon)
                .schemaType("approach")
                .child(S.documentTypeList("approach").title("Approach Phases")),

              // 4. Skills Management (UPDATED)
              S.listItem()
                ...
                .child(
                  S.list()
                    ...
                    .items([
                      // Original Detailed Skills (for grids/progress bars)
                      S.listItem()
                        .title("Detailed Skills (Grid)")
                        .icon(AsteriskIcon)
                        .schemaType("skill")
                        .child(
                          S.documentTypeList("skill").title("Detailed Skills")
                        ),

                      S.divider(),

                      // New Marquee Categories (for infinite scroll)
                      S.listItem()
                        .title("Marquee Categories")
                        .icon(TagIcon)
